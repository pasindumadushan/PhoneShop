<%@page import="srch.user"%>
<%@page import="srch.UpdateServlet"%>
<%@page import="srch.updatemsg"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="srch.UserServlet"%>
<html>
<head>
...
<script type="text/javascript" src="scripts/jquery-1.9.1.min.js"></script>
  ...
  <% if(session.getAttribute("user")!=null){
      ...
      out.println( "<Title>"+session.getAttribute("user")+"'s"+" Profile"+"</title>");
  }
...
<form action="login.jsp"><input name="Login" type="submit" id="Login" value="Login"></form>
<br>
<br>
<br>
...
<table border="0" cellspacing="0" cellpadding="0"  width=80% height=60% >
  <tr>
    <td colspan="3" align="center"><table width="993" border="0" align="center">
      <tr>
        <td colspan="7"><span style="font-size:30px;t"><img src="images/de.png" width="800" height="100"  alt=""/></span></td>
        </tr>
        <br>       
   <br>       
   ...
   <br> 
      <tr>
        ...
        <td width="2">:</td>
        <td width="214" align="left"><input name="una" type="text" disabled id="una" value= "<%= ur.getRs().getString("username")%> " size="35"></td>
        <td width="226" align="left">&nbsp;</td>
        <td width="163" align="left">Email</td>
        <td width="2" align="left">:</td>
        <td width="212" align="left"><input name="email" type="text" disabled id="email" size="35" value=<%= ur.getRs().getString("email")%> </td>
      ...
      <tr>
        <td>Password</td>
        <td>:</td>
        <td><a href="Updatepw.jsp" target="_parent" style="color: #00C"><u>Update Your Password</u></a></td>
        <td>
        ...
        <td>Mobile Number</td>
        <td width="2" align="left">:</td>
        <td><input name="mNo" type="text" disabled id="mNo" size="35" value=<%= ur.getRs().getString("mNo")%>  ></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td>First Name</td>
        <td>:</td>
        <td><input name="fN" type="text" disabled id="fN" size="35" value=<%= ur.getRs().getString("fN")%> ></td>
        <td>&nbsp;</td>
        <td>Land Number</td>
        <td width="2" align="left">:</td>
        <td><input name="lNo" type="text" disabled id="lNo" size="35" value=<%= ur.getRs().getString("lNo")%> ></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td>Middle Name</td>
        <td>:</td>
        <td><input name="mN" type="text" disabled id="mN" size="35" value=<%= ur.getRs().getString("mN")%>  ></td>
        <td>&nbsp;</td>
        <td>Address</td>
        <td width="2" align="left">:</td>
        <td><input name="addr" type="text" disabled id="addr" size="35" value= <%= ur.getRs().getString("addr")%>  ></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td>Last Name</td>
        <td>:</td>
        <td><input name="lN" type="text" disabled id="lN" size="35" value= <%= ur.getRs().getString("lN")%>  ></td>
        <td>&nbsp;</td>
        <td>Country</td>
        <td width="2" align="left">:</td>
        <td><input name="country" type="text" disabled id="country" size="35" value= <%= ur.getRs().getString("country")%>  ></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td><span style="color:#900">
          &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;  &nbsp;  &nbsp;&nbsp; 
          <input name="submit" type="submit" disabled="disabled" id="submit" value="Submit">
          <input type="button" name="edit" id="edit" value="Edit" onClick=email.disabled=false;mNo.disabled=false;lNo.disabled=false;submit.disabled=false;fN.disabled=false;mN.disabled=false;lN.disabled=false;country.disabled=false;addr.disabled=false>
        </span></td>
        <td>&nbsp;</td>
        <td width="2" align="left">:</td>
        <td>&nbsp;</td>
...
<!--End Bottle-->
  ...
  <tr>
    ...
    <td width="12.5%"  align="center" ><h3><a href="#" target="new"><img src="images/social/tw.gif" width="40" height="40"></a></h3></td>
