	...
	tba(document).ready(function(){  
            ...
            tba(document).scroll(function() { 
                ...
                if(scroll_pos > 25) {
					...
					tba("#topbar").css('background-color', '#A52223');
					...
					tba("#topbar a").css('color', '#A52223');
					tba(".vm_sum").css('color', '#A52223');
					tba("#topbar div").css('color', '#A52223');
...
<!--End Top menu JS -->
<!--Start Js bottle rollover --><!--Start Top menu JS -->
var tba = jQuery.noConflict();
	tba(document).ready(function(){  
            var scroll_pos = 0;
            tba(document).scroll(function() { 
...
<body onLoad="MM_preloadImages('images/menu/Spirit_r.gif')">
...
<table width="100%" border="0" background="images/menu/bg.gif" style="position:relative; top:8px">
  <tr>
    ...
    <td><img src="images/menu/Our_Stores_r.gif" width="115" height="27"  alt=""/></td>
...
<tr>
<td colspan="3"><h1 style="color:#900">Our Stores</h1></td>
</tr>
  <tr>
    
    <td><h4>Level 13, <br>Ceylinco House, <br>69 janadhipathi Mawatha, <br>Colombo 01</h4></td>
    <td><h4>15, <br>Sir Chittampalam A. Gardiner Mawatha, <br>Colombo 02</h4></td>
    </tr>
    <tr>
    <td><h4>Dutch Hospital Shopping Precinct, <br>Bank Of Ceylon Mw, <br>Colombo 01</h4></td>
    <td><h4>2, <br>Station Avenue, <br>Colombo 06</h4></td>
    </tr>
