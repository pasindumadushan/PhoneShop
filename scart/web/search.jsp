...
<br><br><a href="JavaScript:phonePopup('Search?phone=<%=sr.getRs().getString("name")%>');" id="lnk"><%=sr.getRs().getString("name")%></a>
    ...
    <br>
        <%}else{%>
        <br><br><br><center>
<img src="images/not-found-error.png" width="770" height="211"  alt=""/><br><br><br><br>	
<h1>No result found for "<%=request.getAttribute("sString")%>"</h1></center>
<br><br><br><br>

<%}%>       

        <!--else for if(request.getAttribute("sString")!=null)-->         
<% }else{%>   
<br><br><br>
<center><img src="images/not-found-error.png" width="770" height="211"  alt=""/><br><br><br><br></center>
	
<center><h1>Please enter a search term</h1></center><br><br><br><br>
                <%}%>
